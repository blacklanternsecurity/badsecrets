...
def test_include_machinekeys():
    ...
    r = x.check_secret(known_good_dialogparameters_machinekey,key_derive_mode="PBKDF2")
    assert r
    assert r['Telerik.Web.UI.DialogParametersEncryptionKey'] == "F8517F88738C8AB8576156C98961700D274DA366B58B24D7F534699367D809E2"
