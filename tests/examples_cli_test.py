...
def test_example_cli_hashcat_peoplesoft(monkeypatch, capsys):
    ...
    captured = capsys.readouterr()
    assert (
        "[Peoplesoft_PSToken] Peoplesoft PS_TOKEN Password Command: [hashcat -m 13500 -a 0 f99988a81bf8b7db91ac0471cdc8320cfbdc9fd4:750000000403020101000000bc020000000000001462006100640073006500630072006500740073000645004e0047000e50005300460054005f00480052003432003000320032002d00310030002d00310033002d00300039002e00350030002e00330039002e0039003900390035003400330000  <dictionary_file>"
        in captured.out
    )
